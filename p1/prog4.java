...
public static void main(String args[]) throws FileNotFoundException,IOException
      {
            ...
            {
             rc[i] = new record();
            String[] dataarray = data.split(","); for(int j=0;j<7;j++)
           rc[i].attr[j] = Integer.parseInt(dataarray[j]); data = csv.readLine();
            i++;
             }
...
System.out.println("entrpoy="+entropy[0]); System.out.println("gini="+gini[0]); System.out.println("gain="+gain[0]);
System.out.println("entrpoy="+entropy[1]); System.out.println("gini="+gini[1]); System.out.println("gain="+gain[1]);
System.out.println("entrpoy="+entropy[2]); System.out.println("gini="+gini[2]); System.out.println("gain="+gain[2]);
}}
