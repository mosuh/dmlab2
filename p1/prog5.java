...
{
BufferedReader csv = new BufferedReader(new FileReader(new File("data5.csv")));
...
System.out.println("size :Sgiven class"+i+":"+probability(y,"S"));
System.out.println("size :Mgiven class"+i+":"+probability(y,"M"));
System.out.println("size :Lgiven class"+i+":"+probability(y,"L")+"\n");



System.out.println("--Class N--");
System.out.println("Mean :"+mean2+ "\tStandard deviation: "+sd2);
System.out.println("size :Sgiven class"+i+":"+probability(n,"S"));
System.out.println("size :Mgiven class"+i+":"+probability(n,"M"));
System.out.println("size :Lgiven class"+i+":"+probability(n,"L")+"\n");
