...
double B=-1000;
//y=5x+2
double mean_x=0,mean_y=0,cov_xy=0,var_x=0; double[] x = { 1, 2, 3, 4, 5, 6, 7, 8 };
...
M = cov_xy/var_x;
B = mean_y-M*mean_x; System.out.println("enter the value for x"); Scanner in = new Scanner(System.in);
double r = in.nextInt();
double res = r*M+B;
